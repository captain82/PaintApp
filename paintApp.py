...
#5*5 kernel for erosion and dilution
...
#Draw buttons like colored rectangle
...
while True:
    ...
    #Add the same paint interface to the camera feed
    ...
    #Determine which pixels fall within the blue boundary
    ...
    #Check to see if any blue Contours is found
    if len(cnts)>0:
